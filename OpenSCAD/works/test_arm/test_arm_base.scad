...
*difference(){
    ...
    translate([3, -4, 0]) cube([5, 2, 12]);
    translate([12, -4, 0]) cube([5, 2, 12]);
...
union() {
    ...
    hull() {
        translate([12.8, -3.9, 12]) cube([5, 1.8, 0.1]);
        translate([12.8, -3.9, 0]) cube([5, 2.1, 0.1]);
    }
    difference(){
        translate([2.8, -3.9, 3.5]) rotate([0, 90, 0]) cube([5, 2, 15]);
        translate([10.12, 0, 6]) rotate([90, 0, 0]) cylinder(h=10, r=3.6, center=false);
    }
}
