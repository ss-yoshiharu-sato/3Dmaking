...
difference(){
    union() {
        translate([-26.5, -34.8, -23.6]) rotate([90, 0, 0]) import("M5_Nut.stl", convexity=3);
        hull() {
            translate([0, 0, 2]) cylinder(h=0.1, r=6, center=false);
            translate([0, 0, 10]) cylinder(h=0.1, r=10, center=false);
            translate([0, 0, 15]) cylinder(h=0.1, r=10, center=false);
            translate([0, 0, 30]) cylinder(h=0.1, r=6, center=false);
        }
        hull() {
            translate([0, 0, 30]) cylinder(h=10, r=6, center=false);
            translate([0, 0, 41]) cylinder(h=0.1, r=5, center=false);
        }
    }
    translate([0, 10, 35]) rotate([90, 0, 0]) cylinder(h=20, r=2.5, center=false);
}

// difference(){
//     union() {
//         translate([7.2, 0, 0]) cube([5.8, 3, 30]);
//         hull() {
//             translate([5, 2, 0]) cube([10, 1.5, 30]);
//             translate([7.4, 5.5, 0]) cube([5.3, 0.1, 30]);
//         }
//     }
